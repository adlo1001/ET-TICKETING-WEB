...
<button onClick ={()=>setToggleForm1(!toggleForm1)}
      className={`m-2 bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md ${toggleForm1? 'rounded-t-md':'rounded-md'}`}>
        <div><BiBus className="inline-block align-text-top" />  ADD TICKET</div>
      </button>{ toggleForm1 &&   
    <div className="flex justify-center">
            ...
            <input type="text" name="ticketNumber" id="ticketNumber"  
               className="m-2 pl-8 rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300" placeholder="Ticket Number Type eg. 99999997787" />
</div> 
      
      <div className=" flex justify-center">
<input type="text" name="numberOfAdults" id="numberOfAdults"  
   className="m-2 pl-8 rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300" placeholder="Number of Adult Passengers eg. 1" />
</div>
<div className=" flex justify-center">
<input type="text" name="numberOfKids" id="numberOfKids"  
   className="m-2 pl-8 rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300" placeholder="Number of Kid Passengers eg. 2" />
</div>
<div className=" flex justify-center">
<input type="text" name="numberOfInfants" id="numberOfInfants"  
   className="m-2 pl-8 rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300" placeholder="Number of Infant Passengers eg. 1" />
</div>
<div className=" flex justify-center">
<input type="text" name="numberOfDisabled" id="numberOfDisabled"  
   className="m-2 pl-8 rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300" placeholder="Number of Disabled Passengers eg. 0" />
</div>
<div className=" flex justify-center">
<input type="text" name="grossPriceAmnt" id="grossPriceAmnt"  
   className="m-2 pl-8 rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300" placeholder="Ticket Price eg. 480.00" />

</div>

<div className=" flex justify-left">
<p className="m-2 text-1xl mb-3" href="#">  
        ISSUE DATE</p>
...
<div className="pt-5">
            ...
            <div className="flex justify-center"><p>SECTION 1</p></div>
            <div className="p-2 flex justify-center">
...
<div className="m-1 justify-center border border-dark">
<div className="flex justify-center"><p>SECTION 2</p></div>
  <div className="p-2 flex justify-center">
  <select  class=" m-2 form-select form-select-sm mb-5" aria-label=".form-select-sm example">
...
<div className="m-1 flex justify-center border border-dark">
            ...
            <div className="pt-5">
            <div className="flex justify-center "><p>SECTION 3</p></div>
...
<button onClick ={()=>setToggleForm2(!toggleForm2)}
      className={`m-2 bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md ${toggleForm2? 'rounded-t-md':'rounded-md'}`}>
        <div><BiBus className="inline-block align-text-top" />  EDIT TICKET</div>
      </button>{ toggleForm2 &&   
    <div className="flex justify-center">
...
<select  class=" m-2 form-select form-select-sm mb-5" aria-label=".form-select-sm example">
  <option selected>TiCKET ID</option></select><p class="m-3"> optional</p></div> 
